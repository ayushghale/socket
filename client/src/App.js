    ...
    <div className="text-2xl flex flex-col">
      ...
      <form>
        ...
        <div className="flex flex-col w-[50%] mx-auto border border-solid border-4 border-black p-4 rounded-xl">
              ...
              <div key={index} className=" ">
                ...
                {name === item.name ? (
                  ...
                  <div className="w-fit mr-auto flex">
                    <div className="flex flex-col bg-gray-500 rounded-2xl rounded-br-none  px-4 py-2">
                      <h1 className="font-bold text-lg">{`${item.name}`}</h1>
                      <p className="left-0 text-2xl w-fit ml-auto mt-1">
                        {item.text}
                      </p>
          ...
          <div className="border border-solid border-4  border-black  p-2 rounded-xl  w-full  flex">
            <input
              type="text"
              value={message}
